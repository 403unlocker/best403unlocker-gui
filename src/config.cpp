...
const static std::string DEFAULT_DNS_LIST[] = {
    "178.22.122.100", "185.51.200.2",  "78.157.42.100", "78.157.42.101", "10.202.10.202",
    "10.202.10.102",  "185.55.226.26", "185.55.225.25", "10.202.10.10",  "10.202.10.11"};
   ...
   if (!std::filesystem::exists(configFilePath)) {
      ...
      if (output.is_open()) {
         ...
         for (int i = 0; i < dnsListSize; i++)
            output << '"' << DEFAULT_DNS_LIST[i] << '"' << (i == dnsListSize - 1 ? "" : ", ");
